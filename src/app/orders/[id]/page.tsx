        ...
        <div className="max-w-3xl mx-auto space-y-6 md:space-y-8">
          ...
          <header className="flex flex-col md:flex-row md:items-center gap-4">
            <div className="flex items-center gap-4">
              <Link href="/orders" className="p-2 bg-white border border-slate-200 rounded-xl hover:bg-slate-50 transition-colors text-slate-500">
              ...
              <div>
                <h1 className="text-2xl md:text-3xl font-extrabold tracking-tight text-slate-900">Edit Order</h1>
                <p className="text-sm md:text-base text-slate-500 font-medium mt-1">For {order.customers?.full_name}</p>
              </div>
            </div>
          </header>
